...
export const getCategories = () => {
    let retrievedBox = localStorage.getItem('categories');
		...
		console.log("getCategories: ", retrievedCategories);
...
export function addCategory(categoryId, categoryName) {
...
//******************READ**************************
//****************WILL NEED**********************************
 //  Everytime function getCategories ()  is called
...
export function readCategoryComplete() {
	let list = categories.map((currentElement, index) => {
...
export function updateCategoryId(CurrentCategoryId, newCategoryId) {
...
export function updateCategoryName(CurrentCategoryName, newCategoryName) {
	categories.forEach((currentElement, index) => {
